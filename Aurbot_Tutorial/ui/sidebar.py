...
def sidebar_items() -> rx.Component:
    return rx.vstack(
        ...
        sidebar_item("Courses", "book", navigation.routes.COURSES_ROUTE),
        sidebar_item("AuroBot", "bot", navigation.routes.AUROBOT_ROUTE),
        sidebar_item("Python IDE", "code", navigation.routes.PYTHON_IDE_ROUTE),  # Add Python IDE link
        sidebar_item("mBlock IDE", "code", navigation.routes.MBLOCK_IDE_ROUTE),  # Add mBlock IDE link
        rx.cond(
            SessionState.is_admin,
            sidebar_item("Add Course", "plus", navigation.routes.ADD_COURSE_ROUTE),
            rx.fragment("")
        ),
        spacing="1",
        width="100%",
...
#         ),
#     ]
#     return rx.vstack(*items, spacing="1", width="100%")
